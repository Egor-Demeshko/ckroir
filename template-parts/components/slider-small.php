...
if ($query->have_posts()) {
    ...
    ?>
        ...
        <section class="glide info_slide" aria-label="<?php _e("Маленький слайдер", "ckror");?>">
    ...
    <?php
            ...
            while ($query->have_posts()) {
                ...
                $description = get_field('ckror_slider_small_description');
                ...
                ?>
                <li class="glide__slide info_slide__slide_wrapper" role="option" aria-label="<?php _e("Слайд", "ckror"); ?>">
                    <div class="info_slide__slide">
                        ...
                        aria-label="<?php _e("Ссылка на публикацию или страницу, где больше информации", "ckror");?>">
                            ...
                            <p class="info_slide__title">
                                <?php echo ($heading && $heading !== "") ? $heading : get_the_title(); ?></p>
                            <?php 
