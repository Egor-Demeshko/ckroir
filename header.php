  ...
  <body>
    <header class="header">
        ...
        <div class="alternate_menu__wrapper" id="alternate_menu__wrapper">
            <div class="container">
                <div class="row alternate_menu padding_on_left_right">
                    <div class="alternate_menu__logo">
                        <img src="/assets/images/aist.jpeg" alt="Детский сад «Лошадка»">
                    </div>
                    <nav class="top-menu alternate_menu__menu">
                        <ul id="alternate_menu" class="top-menu__main_list eliminate_list"> 
                            <li class="top-menu__list-item" data-index="0"><a href="/v2/" class="active">Главная</a></li>
                            <li class="dropdown top-menu__list-item" data-index="1">
                                <a href="/v2/sveden/">Сведения об организации</a>
                                <ul class="dropdown-menu eliminate_list" >
                                
                                    <li><a href="/v2/sveden/common/">Основные сведения</a></li>
                                    
                                    <li><a href="/v2/sveden/struct/">Структура и органы управления образовательной организацией</a></li>
                                    
                                <li class="dropdown-sub">
                                    <a href="/v2/sveden/document/">Документы</a>
                                    <ul class="dropdown-sub-menu right eliminate_list">
                                    ...
                                    <li><a href="/v2/sveden/education/">Образование</a></li>
                                    
                                    <li><a href="/v2/sveden/eduStandarts/">Образовательные стандарты</a></li>
                                    
                                    <li><a href="/v2/sveden/employees/">Руководство. Педагогический (научно-педагогический) состав</a></li>
                                    
                                    <li><a href="/v2/sveden/objects/">Материально-техническое обеспечение и оснащенность образовательного процесса</a></li>
                                    
                                    <li><a href="/v2/sveden/grants/">Стипендии и меры поддержки обучающихся</a></li>
                                    
                                    <li><a href="/v2/sveden/paid_edu/">Платные образовательные услуги</a></li>
                                    
                                    <li><a href="/v2/sveden/budget/">Финансово-хозяйственная деятельность</a></li>
                                    
                                    <li><a href="/v2/sveden/vacant/">Вакантные места для приема (перевода)</a></li>
                                    
                                    <li><a href="/v2/sveden/ovz/">Доступная среда</a></li>
                                    
                                    <li><a href="/v2/sveden/inter/">Международное сотрудничество</a></li>
                                    
                                </ul>
                            </li>
                            <li class="dropdown top-menu__list-item" data-index="2">
                                <a href="/v2/sveden/document/">Документы</a>
                                <ul class="dropdown-menu eliminate_list" >
                            ...
                            <li data-index="3" class="top-menu__list-item">
                                <a href="/v2/timetable/">Расписание</a>
                            </li>
                            <li class="dropdown top-menu__list-item" data-index="4">
                                <a href="/v2/people/">Коллектив</a>
                                <ul class="dropdown-menu eliminate_list" >
                            ...
                            <li class="dropdown top-menu__list-item" data-index="5">
                                <a href="/v2/parents/">Родителям</a>
                                <ul class="dropdown-menu eliminate_list" >
                            ...
                            <li data-index="6" class="top-menu__list-item"><a href="/v2/news/">Новости</a>
                            </li>
                            <li class="dropdown top-menu__list-item" data-index="7">
                                <a href="/v2/media/">Медиа</a>
                                <ul class="dropdown-menu eliminate_list" >
                            ...
                            <li class="dropdown  etc top-menu__list-item" data-menu="etc">
                                <a href="#" rel="nofollow"><i class="icon-etc"><span></span><span></span><span></span></i>
                                </a>
                                
                                <ul class="dropdown-menu  eliminate_list" data-sublist="etc-list">
                                    
                                    <li class="etc-list-item" data-index="8"><a href="/v2/anticorruption/">Антикоррупционная деятельность</a></li>
                                    <li class="dropdown dropdown-sub etc-list-item" data-index="9">
                                        <a href="/v2/direction/">Направления</a>
                                        <ul class="dropdown-sub-menu left eliminate_list">
                                    ...
                                    <li class="etc-list-item" data-index="10"><a href="/v2/reviews/">Отзывы</a></li>
                                
                                    <li class="etc-list-item" data-index="11"><a href="/v2/contacts/">Контакты</a></li>
                                </ul>
                            </li>  
                        </ul>
                    </nav>
        ...
        <div class="header__menu-row d-none d-lg-block">
            <div class="container">
                ...
                <nav class="top-menu">
                    <ul id="menu" class="top-menu__main_list eliminate_list"> 
                        <li class="top-menu__list-item" data-index="0"><a href="/v2/" class="active">Главная</a></li>
                        <li class="dropdown top-menu__list-item" data-index="1">
                            <a href="/v2/sveden/">Сведения об организации</a>
                            <ul class="dropdown-menu eliminate_list" >
